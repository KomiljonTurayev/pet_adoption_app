...
import 'package:pet_adoption_app/models/onboards_model.dart';
import 'package:pet_adoption_app/pages/home.dart';
          ...
          Container(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) =>
                  OnBoardContent(onBoard: onBoardData[index]),
            ),
          ),
          GestureDetector(
            onTap: () {
  ...
  AnimatedContainer indicator({int? index}) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          ...
          color: currentPage == index ? Colors.orange : black.withOpacity(0.6)),
    );
  }
}
